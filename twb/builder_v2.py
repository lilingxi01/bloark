...
class Builder:
    ...
    def _decompress_executor(self, file_path: str):
        # Initialize temporary directory.
        temp_dir = os.path.join(self.output_dir, 'temp')
        os.makedirs(temp_dir, exist_ok=True)

        archive_filename = os.path.basename(file_path)
        decompressed_dir_name = archive_filename.split('.')[:-1]
        decompressed_path = os.path.join(temp_dir, decompressed_dir_name)
        ...
        decompressed_files = get_file_list(decompressed_path)
